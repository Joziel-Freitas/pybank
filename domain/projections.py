"""Domain Projections and Rule Evaluation Results Module.

Defines immutable read models, financial snapshots, and specification evaluation
results generated by Domain Entities. These objects serve as cohesive, typed contracts
to project state and decision outcomes to the Application and Presentation layers.
"""
...
from domain.types import AccrualType
